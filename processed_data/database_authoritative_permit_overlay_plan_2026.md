...
Populated numeric permit cells in canonical DATABASE.csv are direct Utah DWR Hunt Planner truth. This plan only directs derived outputs to use DATABASE values where populated; it does not modify DATABASE.csv or promote comparison-source values over DATABASE.csv.
