...
RESOLUTIONS: dict[str, dict[str, str]] = {
    ...
    "DB1774": {
        "resolution_status": "RESOLVED_HISTORICAL_DRAW_REALITY_CODE_NO_CURRENT_DATABASE_ROW",
        "mapped_hunt_code": "DB1774",
        "mapped_boundary_id": "",
        "maps_to_draw_odds_code": "YES_HISTORICAL_DRAW_REALITY_ENGINE",
        "evidence": "DB1774 appears in draw_reality_engine as Chalk Creek/East Canyon/Morgan-South Rich any-legal-weapon draw-results evidence; no current 2026 DATABASE row exists.",
    ...
    "PB5343": {
        "resolution_status": "RESOLVED_OFFICIAL_PRONGHORN_TABLE_AND_POINT_LADDER_CODE",
        "mapped_hunt_code": "PB5343",
        "mapped_boundary_id": "919",
        "maps_to_draw_odds_code": "YES_POINT_LADDER_CODE",
        "evidence": "PB5343 appears in official pronghorn hunt table as Prohibition Springs CWMU and in point_ladder_view; no current 2026 DATABASE row exists.",
