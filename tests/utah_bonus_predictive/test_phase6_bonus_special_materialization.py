...
def test_phase6_bonus_special_artifacts_are_generated(tmp_path: Path) -> None:
    subprocess.run(
        [
            sys.executable,
            "-m",
    ...
    csv_path = tmp_path / "phase6_bonus_special_predictions_v1.csv"
    json_path = tmp_path / "phase6_bonus_special_report.json"
