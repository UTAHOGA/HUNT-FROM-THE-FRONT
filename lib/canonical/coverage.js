...
function writeCoverage(usage, validationStatus = {}, now = new Date().toISOString()) {
  ...
  writeJson('canonical/four-page-canonical-coverage.json', coverage);
...
`, 'utf8');
  ...
  fs.writeFileSync(abs('docs/four-page-canonical-coverage.md'), `# Four-Page Canonical Coverage (Scoped)
